...
trait MemoryTypedStoreFixtures[Ident, T] extends MemoryStreamStoreFixtures[Ident] with TypedStoreFixtures[Ident, T, MemoryStreamStore[Ident], MemoryTypedStore[Ident, T], MemoryStore[Ident, MemoryStoreEntry]] {
