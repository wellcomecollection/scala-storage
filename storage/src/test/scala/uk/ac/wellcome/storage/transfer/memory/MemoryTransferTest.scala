...
class MemoryTransferTest extends TransferTestCases[String, Array[Byte], MemoryStore[String, Array[Byte]], MemoryTransfer[String, Array[Byte]], MemoryStore[String, Array[Byte]]] with MemoryTransferFixtures[String, Array[Byte]] with RandomThings {
