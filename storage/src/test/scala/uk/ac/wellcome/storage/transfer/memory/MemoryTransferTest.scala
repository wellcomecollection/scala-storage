...
class MemoryTransferTest extends TransferTestCases[String, Array[Byte], String, MemoryStore[String, Array[Byte]] with MemoryTransfer[String, Array[Byte]]] with MemoryTransferFixtures[String, Array[Byte]] with StringNamespaceFixtures {
